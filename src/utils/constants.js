...
export const AREAS_APOYO = [
  {
    ...
    descEN: 'Doctors, nursing, psychology, first aid.',
    hasSub: true,
    subId: 'sub-salud',
  },
  {
    value: 'Evaluación Estructural / Ingeniería',
    label: 'Evaluación Estructural / Ingeniería',
    labelEN: 'Structural Assessment / Engineering',
    desc: 'Ingenieros civiles, arquitectos e inspección de edificaciones vulnerables.',
    descEN: 'Civil engineers, architects and inspection of vulnerable structures.',
    hasSub: false,
  },
  {
    value: 'Logística / Acopio',
    label: 'Logística / Acopio',
    labelEN: 'Logistics / Drop-off',
    desc: 'Clasificar, empacar y despachar insumos.',
    descEN: 'Sorting, packing and dispatching supplies.',
    hasSub: false,
  },
  {
    value: 'Transporte',
    ...
    descEN: 'Moving people or cargo.',
    hasSub: true,
    subId: 'sub-transporte',
  },
  {
    value: 'Comunicaciones / Redes',
    label: 'Comunicaciones / Redes',
    labelEN: 'Communications / Social Media',
    desc: 'Manejo de redes sociales, diseño gráfico, prensa y difusión de información.',
    descEN: 'Social media management, graphic design, press and outreach.',
    hasSub: false,
  },
  {
    value: 'Asesoría Legal / Trámites',
    label: 'Asesoría Legal / Trámites',
    labelEN: 'Legal Advice / Documentation',
    desc: 'Abogados, salvoconductos, apoyo institucional y atención a víctimas.',
    descEN: 'Lawyers, permits, institutional support and legal assistance.',
    hasSub: false,
  },
  {
    value: 'Telecomunicaciones / Electricidad',
    label: 'Telecomunicaciones / Electricidad',
    labelEN: 'Telecoms / Electrical Support',
    desc: 'Operadores de radio, técnicos eléctricos, energía solar y redes en campo.',
    descEN: 'Radio operators, electrical technicians, solar power and field networks.',
    hasSub: false,
  },
  {
    value: 'Recreación / Familias',
    label: 'Recreación / Familias',
    labelEN: 'Recreation / Families',
    desc: 'Acompañamiento a niños y familias.',
    descEN: 'Support for children and families.',
    hasSub: false,
  },
  {
    value: 'Soporte a rescatistas',
    label: 'Soporte a rescatistas',
    labelEN: 'Rescue team support',
    desc: 'Alimentación, hidratación y relevo de brigadas.',
    descEN: 'Food, hydration and shift relief for brigades.',
    hasSub: false,
  },
  {
    value: 'Otra área de apoyo',
    label: 'Otra área de apoyo',
    labelEN: 'Other support area',
    desc: 'Especifica cualquier otra especialidad, oficio o forma de ayudar no listada.',
    descEN: 'Specify any other specialty, trade or skill not listed above.',
    hasSub: true,
    subId: 'sub-otra',
  },
];
