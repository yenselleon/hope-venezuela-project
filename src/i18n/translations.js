...
const translations = {
  ...
  'registro.error': {
    es: 'Ocurrió un error al enviar el registro. Por favor intenta de nuevo.',
    en: 'An error occurred while submitting your registration. Please try again.',
  },
  ...
  'campo.email': { es: 'Correo electrónico', en: 'Email address' },
  'campo.email.placeholder': { es: 'Ej. maria.gonzalez@correo.com', en: 'e.g. maria.gonzalez@example.com' },
  ...
  'admin.filter.zona.caracas': { es: 'Distrito Capital · Caracas', en: 'Distrito Capital · Caracas' },
  ...
  'admin.chip.asignado': { es: 'Estado: asignado', en: 'Status: assigned' },

  // Table headers
  'admin.table.nombre': { es: 'Nombre', en: 'Name' },
  'admin.table.cedula': { es: 'Cédula', en: 'ID' },
  'admin.table.email': { es: 'Correo', en: 'Email' },
  'admin.table.area': { es: 'Área', en: 'Area' },
  'admin.table.areas': { es: 'Áreas', en: 'Areas' },
  ...
  'admin.field.none': { es: 'Sin asignar', en: 'None' },
  'admin.filter.all': { es: 'Selecciona…', en: 'Select…' },
  ...
  'admin.drawer.email': { es: 'Correo electrónico', en: 'Email' },
  ...
  'admin.editVolunteer.title': { es: 'Editar voluntario', en: 'Edit volunteer' },
  'admin.editVolunteer.btn': { es: 'Editar voluntario', en: 'Edit volunteer' },
  'admin.editVolunteer.cancel': { es: 'Cancelar', en: 'Cancel' },
  'modal.cancel': { es: 'Cancelar', en: 'Cancel' },
  'admin.editVolunteer.save': { es: 'Guardar cambios', en: 'Save changes' },
  'admin.editVolunteer.saving': { es: 'Guardando…', en: 'Saving…' },
  'admin.editVolunteer.success': { es: 'Datos del voluntario actualizados correctamente', en: 'Volunteer details updated successfully' },
  'admin.editVolunteer.tabPersonal': { es: 'Datos personales', en: 'Personal data' },
  'admin.editVolunteer.tabAreas': { es: 'Áreas y capacidades', en: 'Areas & skills' },
  'admin.editVolunteer.tabAvailability': { es: 'Disponibilidad y logística', en: 'Availability & logistics' },
  'admin.editVolunteer.tabAssignment': { es: 'Estado y asignación', en: 'Status & assignment' },
  'admin.editVolunteer.extranjero': { es: '¿Reside en el extranjero?', en: 'Resides abroad?' },
  'admin.editVolunteer.pais': { es: 'País de residencia', en: 'Country of residence' },
  'admin.editVolunteer.otraArea': { es: 'Especificar otra área', en: 'Specify other area' },
  'admin.editVolunteer.desiredZones': { es: 'Zonas deseadas', en: 'Desired zones' },

  // Detail aliases & expansion
  'admin.detail.title': { es: 'Detalle del voluntario', en: 'Volunteer detail' },
  'admin.detail.sensitive': { es: 'Datos sensibles', en: 'Sensitive data' },
  'admin.detail.createdAt': { es: 'Fecha de registro', en: 'Registration date' },
  'admin.detail.ageGender': { es: 'Edad · género', en: 'Age · gender' },
  'admin.detail.profesion': { es: 'Profesión / Ocupación', en: 'Profession / Trade' },
  'admin.detail.ubicacion': { es: 'Residencia / Origen', en: 'Residence / Origin' },
  'admin.detail.areas': { es: 'Áreas y capacidades', en: 'Areas & skills' },
  'admin.detail.especialidad': { es: 'Especialidad salud', en: 'Health specialty' },
  'admin.detail.grado': { es: 'Grado académico', en: 'Academic degree' },
  'admin.detail.certificaciones': { es: 'Certificaciones', en: 'Certifications' },
  'admin.detail.vehiculo': { es: 'Vehículo', en: 'Vehicle' },
  'admin.detail.disponibilidad': { es: 'Disponibilidad semanal', en: 'Weekly availability' },
  'admin.detail.duracion': { es: 'Duración / Modalidad', en: 'Duration / Modality' },
  'admin.detail.movilizacion': { es: 'Movilización', en: 'Transportation' },
  'admin.detail.hospedaje': { es: 'Hospedaje', en: 'Accommodation' },
  'admin.detail.apoyoLogistico': { es: 'Apoyo logístico', en: 'Logistical support' },
  'admin.detail.familia': { es: 'Acompañamiento familiar', en: 'Family accompaniment' },
  'admin.detail.zoneAssigned': { es: 'Zona asignada', en: 'Assigned zone' },
  'admin.detail.desiredZone': { es: 'Zona deseada', en: 'Desired zone' },
  'admin.detail.notasAdmin': { es: 'Notas administrativas', en: 'Administrative notes' },
  'admin.detail.noCerts': { es: 'Sin certificaciones', en: 'No certifications' },
  'admin.detail.noNotes': { es: 'Sin notas registradas', en: 'No notes logged' },
  'admin.detail.noShifts': { es: 'Sin turnos especificados', en: 'No shifts specified' },
  'admin.detail.shift.m': { es: 'Mañana', en: 'Morning' },
  'admin.detail.shift.t': { es: 'Tarde', en: 'Afternoon' },
  'admin.detail.shift.n': { es: 'Noche', en: 'Night' },
  'admin.detail.shift.24h': { es: '24 Horas', en: '24 Hours' },
  'admin.detail.day.lun': { es: 'Lun', en: 'Mon' },
  'admin.detail.day.mar': { es: 'Mar', en: 'Tue' },
  'admin.detail.day.mie': { es: 'Mié', en: 'Wed' },
  'admin.detail.day.jue': { es: 'Jue', en: 'Thu' },
  'admin.detail.day.vie': { es: 'Vie', en: 'Fri' },
  'admin.detail.day.sab': { es: 'Sáb', en: 'Sat' },
  'admin.detail.day.dom': { es: 'Dom', en: 'Sun' },
  ...
  'admin.status.asignado': { es: 'Asignado', en: 'Assigned' },
  ...
  'admin.supply.toast.updated': { es: 'Insumo actualizado con éxito', en: 'Supply updated successfully' },
  'admin.supply.toast.deleted': { es: 'Insumo eliminado del inventario', en: 'Supply deleted from inventory' },
  ...
  'admin.supply.exit.title': { es: 'Registrar salida de insumo', en: 'Register supply exit' },
  'admin.supply.exit.action': { es: 'Registrar salida', en: 'Register exit' },
  'admin.supply.exit.available': { es: 'Disponible', en: 'Available' },
  'admin.supply.exit.reason': { es: 'Motivo de la salida', en: 'Exit reason' },
  'admin.supply.exit.reason.distribution': { es: 'Distribución', en: 'Distribution' },
  'admin.supply.exit.reason.loss': { es: 'Vencido / Merma', en: 'Expired / Loss' },
  'admin.supply.exit.reason.transfer': { es: 'Traslado a otro centro', en: 'Transfer to another center' },
  'admin.supply.exit.reason.other': { es: 'Otro', en: 'Other' },
  'admin.supply.exit.reason.other.placeholder': { es: 'Especifica el motivo…', en: 'Specify the reason…' },
  'admin.supply.exit.destination': { es: 'Destino / Beneficiario', en: 'Destination / Beneficiary' },
  'admin.supply.exit.destination.placeholder': { es: 'Ej. Comunidad Los Teques, familia Pérez…', en: 'e.g. Los Teques community, Pérez family…' },
  'admin.supply.exit.error.qty_invalid': { es: 'Ingresa una cantidad válida mayor a cero.', en: 'Enter a valid quantity greater than zero.' },
  'admin.supply.exit.error.insufficient_stock': { es: 'Stock insuficiente para esta salida.', en: 'Insufficient stock for this exit.' },
  'admin.supply.exit.error.reason_required': { es: 'Especifica el motivo de la salida.', en: 'Specify the reason for the exit.' },
  'admin.supply.movs.filter.type': { es: 'Filtrar por tipo', en: 'Filter by type' },
  'admin.supply.movs.filter.all': { es: 'Todos', en: 'All' },
  'admin.supply.movs.col.date': { es: 'Fecha', en: 'Date' },
  'admin.supply.movs.col.item': { es: 'Ítem', en: 'Item' },
  'admin.supply.movs.col.type': { es: 'Tipo', en: 'Type' },
  'admin.supply.movs.col.qty': { es: 'Cantidad', en: 'Quantity' },
  'admin.supply.movs.col.concept': { es: 'Concepto', en: 'Concept' },
  'admin.supply.movs.col.destination': { es: 'Destino', en: 'Destination' },
  'admin.supply.movs.col.user': { es: 'Usuario', en: 'User' },
  'admin.supply.saving': { es: 'Guardando…', en: 'Saving…' },
  'admin.supply.success': { es: 'Insumo agregado con éxito', en: 'Supply added successfully' },
  'admin.supply.edit': { es: 'Editar insumo', en: 'Edit supply' },
  'admin.supply.delete': { es: 'Eliminar insumo', en: 'Delete supply' },
  'admin.supply.edit.title': { es: 'Editar insumo del inventario', en: 'Edit inventory supply' },
  'admin.supply.delete.confirm.title': { es: '¿Eliminar insumo del inventario?', en: 'Delete inventory item?' },
  'admin.supply.delete.confirm.msg': { es: 'Estás por eliminar permanentemente este insumo. Esta acción no se puede deshacer y se eliminará del catálogo.', en: 'You are about to permanently delete this item. This action cannot be undone and it will be removed from the catalog.' },
  'admin.supply.delete.btn': { es: 'Eliminar insumo', en: 'Delete item' },
  'admin.supply.categories.manage': { es: 'Gestionar categorías', en: 'Manage categories' },
  'admin.supply.categories.title': { es: 'Categorías de insumos', en: 'Supply categories' },
  'admin.supply.category.edit': { es: 'Editar categoría', en: 'Edit category' },
  'admin.supply.category.delete': { es: 'Eliminar categoría', en: 'Delete category' },
  'admin.supply.category.delete.confirm.title': { es: '¿Eliminar categoría?', en: 'Delete category?' },
  'admin.supply.category.delete.confirm.msg': { es: '¿Estás seguro de que deseas eliminar esta categoría? No tiene insumos asignados.', en: 'Are you sure you want to delete this category? It has no assigned supplies.' },
  'admin.supply.category.delete.has_items': { es: 'No se puede eliminar la categoría porque contiene insumos asignados. Reasigna o elimina los insumos primero.', en: 'Cannot delete category because it has supplies assigned. Reassign or delete supplies first.' },
  'admin.supply.category.toast.updated': { es: 'Categoría actualizada con éxito', en: 'Category updated successfully' },
  'admin.supply.category.toast.deleted': { es: 'Categoría eliminada con éxito', en: 'Category deleted successfully' },
  ...
  'admin.permisos.tabs.roles': { es: 'Matriz por roles', en: 'Role matrix' },
  'admin.permisos.tabs.users': { es: 'Permisos por usuario', en: 'User-specific permissions' },
  'admin.permisos.user.select': { es: 'Seleccionar usuario', en: 'Select user' },
  'admin.permisos.user.hint': { es: 'Asigna o revoca permisos especiales a un usuario específico sobreescribiendo los de su rol.', en: 'Assign or revoke special permissions to a specific user overriding their role defaults.' },
  ...
  'admin.permisos.action.manage_inventory': { es: 'Gestionar inventario (ver y mover)', en: 'Manage inventory (view & move)' },
  'admin.permisos.action.edit_inventory': { es: 'Editar insumos de inventario', en: 'Edit inventory items' },
  'admin.permisos.action.delete_inventory': { es: 'Eliminar insumos de inventario', en: 'Delete inventory items' },
  'admin.permisos.action.manage_categories': { es: 'Gestionar categorías de inventario', en: 'Manage inventory categories' },
  ...
  'admin.permisos.no_permission': { es: 'No tienes permisos para realizar esta acción', en: 'You do not have permission to perform this action' },
